...
function datepicker(locals) {
  ...
  if (
    ...
    throw new Error(`ERROR! Unrecognized date picker format! ${datePickerMode}`);
  }
        ...
        <View style={datepickerStyle}>
          ...
          <TouchableNativeFeedback
            ...
            onPress={function () {
              ...
              DateTimePicker.open(config).then(function (date) {
                if (date.action !== DateTimePicker.dismissedAction) {
          ...
          <TouchableNativeFeedback
            ...
            onPress={function () {
              ...
              DateTimePicker.open({
                ...
                if (time.action !== DateTimePicker.dismissedAction) {
